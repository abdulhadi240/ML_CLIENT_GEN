...
def Data_Gro() -> str :
        ...
        response = client.chat.completions.create(
            ...
            messages=[
                {"role": "system", "content": "You are a expert in making json format.  as shown : 'Data':[541,432,644,876,234,...] , use the values given in the user content . values should be 30 cumplsory if values are less adppend the values similar"},
